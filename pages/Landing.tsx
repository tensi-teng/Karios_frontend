      ...
      <section className="pt-48 pb-32 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 mb-8 text-indigo-400 text-xs font-bold"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-7xl font-bold font-display leading-snug mb-8 tracking-tight"
          >
            Privacy First,<br />
          ...
          <motion.p
            ...
            className="text-lg md:text-base text-gray-400 max-w-2xl mx-auto mb-16 leading-relaxed"
          >
          ...
          >
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-indigo-600 rounded-2xl font-bold text-lg hover:bg-indigo-500 transition-all flex items-center justify-center gap-3 glow shadow-indigo-500/20 shadow-2xl"
            >
              Start Your Vault
              <ArrowRight className="w-5 h-5" />
            </button>
            <button className="w-full sm:w-auto px-8 py-4 glass rounded-2xl font-bold text-lg hover:bg-white/10 transition-all text-white border border-white/10">
              Explore Protocol
            </button>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative aspect-square">
              ...
              <div className="relative glass rounded-[3rem] h-full w-full border border-white/10 flex items-center justify-center">
                <Lock className="w-24 h-24 md:w-32 md:h-32 text-indigo-500/50" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold font-display mb-4 text-white">How it Works</h2>
            <p className="text-gray-400 text-base md:text-lg">Three layers of security for complete peace of mind.</p>
          </div>
...
const StepCard: React.FC<{ number: string; title: string; desc: string }> = ({ number, title, desc }) => (
  <div className="p-8 md:p-10 rounded-[2.5rem] glass border border-white/10 relative">
    <span className="text-5xl md:text-6xl font-black text-white/5 absolute top-8 right-8">{number}</span>
